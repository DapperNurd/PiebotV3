...
module.exports = {
    ...
    async execute(interaction, client) {
        ...
        if(interaction.options.getUser("user") && interaction.options.getUser("user") != interaction.user) await mongooseFunctions.giveAndReceive(interaction.user, userProfile, guildProfile, globalProfile);
